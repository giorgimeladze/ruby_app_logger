...
RSpec.describe LogToHashAdapter, type: :helper do
  describe '.convert_to_hash' do
    ...
    context 'returned hash' do
      subject { described_class.new('spec/webserver_test.log') }
